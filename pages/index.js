        ...
        <div className="justify-between lg:max-w-6xl mx-auto lg:max-h-screen items-center">
            ...
            <Header />
                ...
                <div className="flex flex-col lg:flex-row flex-1 justify-between items-center p-20 pt-5 pb-0">
                        <div>
                            <div>
                                <div id="box1" className="box1 bg-[#E4E4E4] dark:bg-[#252525] dark:border-[#3a3a3a] rounded-2xl border-4 mb-10 mt-10 lg:mb-0 lg:mt-0 ease-in-out duration-300">
                        ...
                        <div>
                            <div>
                                <div id="box2" className="box2 rounded-2xl dark:bg-[#383838] dark:border-[#383838] border-4 lg:pl-10 lg:pr-10 pl-3 pr-3 ease-in-out duration-300">
